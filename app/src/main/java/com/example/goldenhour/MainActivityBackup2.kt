...
//
//class MainActivityBackup2 : ComponentActivity() {
...
//        }
//
//        fun showLocationNotification(context: Context, title: String, message: String) {
//
...
//                val title = "Look, sun!"
//                val message = "Go outside and touch grass."
//                showLocationNotification(context, title, message)
//            }
//        }
//
...
//                        showLocationNotification(context, "Location Saved", "Latitude: $latitude, Longitude: $longitude")
//                    }
//                },
