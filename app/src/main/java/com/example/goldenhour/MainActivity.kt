            ...
            Button(
                onClick = {
                    ...
                    if (lat != null && lon != null) {
                        ...
                        var minute = ((goldenHour - hour) * 60).roundToInt()
                        var zeroHour = String.format("%02d", hour)
                        var zeroMinute = String.format("%02d", minute)
                        showNotification(context, "Golden Hour Today: $zeroHour:$zeroMinute", "Go touch grass :)")
                    }
                },
